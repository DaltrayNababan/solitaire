...
public class Move {
    ...
    private final int mToBegin;
    private final int mToEnd;
    ...
    public Move(int from, int toBegin, int toEnd, int count, boolean invert, boolean unhide) {
        mFrom = from;
        mToBegin = toBegin;
        mToEnd = toEnd;
        mCount = count;
    ...
    public Move(int from, int to, int count, boolean invert, boolean unhide) {
        mFrom = from;
        mToBegin = to;
        mToEnd = to;
        mCount = count;
    ...
    public Move(int from, int to, int count, boolean invert, boolean unhide, boolean addDealCount) {
        mFrom = from;
        mToBegin = to;
        mToEnd = to;
        mCount = count;
    ...
    public boolean GetInvert() {
        return (mFlags & FLAGS_INVERT) != 0;
    }

    public boolean GetUnhide() {
        return (mFlags & FLAGS_UNHIDE) != 0;
    }
