...
public class DrawMaster {
    ...
    private final Paint mEmptyAnchorPaint;
    private final Paint mDoneEmptyAnchorPaint;
    private final Paint mShadePaint;
    private final Paint mLightShadePaint;

    private final int roundEdge;    // Round curve on each card corner
    private final int cardOutline;  // Card outline border thickness in pixels
    private final int offset;       // Whitespace between card border and font
    private final Paint mGrnTxtPaint;
    ...
    private void DrawPortraitBigCards() {
        ...
        int w;   // Width  of actual bitmap image
        int h;   // Height of actual bitmap image

        Context context = mContext.getApplicationContext();
        Drawable drawable = ContextCompat.getDrawable(context, R.drawable.cardback);
        ...
        // Load suit bitmaps
        drawable = ContextCompat.getDrawable(context, R.drawable.medsuits);
        assert drawable != null;
        w = drawable.getIntrinsicWidth();
        h = drawable.getIntrinsicHeight();
        int suitWidth = w / 4;
        for (int i = 0; i < 4; i++) {
            suit[i] = Bitmap.createBitmap(w / 4, h, Bitmap.Config.ARGB_8888);
        ...
        drawable = ContextCompat.getDrawable(context, R.drawable.medblackfont);
        assert drawable != null;
        w = drawable.getIntrinsicWidth();
        h = drawable.getIntrinsicHeight();
        ...
        for (int i = 0; i < 13; i++) {
            blackFont[i] = Bitmap.createBitmap(w / 13, h, Bitmap.Config.ARGB_8888);
            canvas = new Canvas(blackFont[i]);
            drawable.setBounds(-i * fontWidth, 0, -i * w / 13 + w, fontHeight);
            drawable.draw(canvas);
        }

        // Load red font bitmaps
        drawable = ContextCompat.getDrawable(context, R.drawable.medredfont);
        for (int i = 0; i < 13; i++) {
            redFont[i] = Bitmap.createBitmap(w / 13, h, Bitmap.Config.ARGB_8888);
    ...
    private void DrawPortraitCards() {
        ...
        Drawable drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.cardback);
        ...
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.medsuits);
        assert drawable != null;
        w = drawable.getIntrinsicWidth();
        h = drawable.getIntrinsicHeight();
        ...
        int bigSuitHeight = h;
        for (int i = 0; i < 4; i++) {
            bigSuit[i] = Bitmap.createBitmap(w / 4, h, Bitmap.Config.ARGB_8888);
        ...
        // Load suit bitmaps
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.smallsuits);
        assert drawable != null;
        w = drawable.getIntrinsicWidth();
        h = drawable.getIntrinsicHeight();
        int suitWidth = w / 4;
        ...
        for (int i = 0; i < 4; i++) {
            suit[i] = Bitmap.createBitmap(w / 4, h, Bitmap.Config.ARGB_8888);
            revSuit[i] = Bitmap.createBitmap(w / 4, h, Bitmap.Config.ARGB_8888);
            canvas = new Canvas(suit[i]);
            drawable.setBounds(-i * w / 4, 0, -i * w / 4 + w, h);
            drawable.draw(canvas);
        ...
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.medblackfont);
        assert drawable != null;
        w = drawable.getIntrinsicWidth();
        h = drawable.getIntrinsicHeight();
        int fontWidth = w / 13;   // Same as for red below
        ...
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.medredfont);
        for (int i = 0; i < 13; i++) {
        ...
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.redjack);
        ...
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.redqueen);
        ...
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.redking);
        ...
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.blackjack);
        ...
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.blackqueen);
        ...
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.blackking);
        ...
        for (int suitIdx = 0; suitIdx < 4; suitIdx++) {
            for (int valueIdx = 0; valueIdx < 13; valueIdx++) {
                ...
                int[] suitY = {topBorder + heightBorder / 5 - suitHeight / 2,
    ...
    private void DrawBigCards() {
        ...
        // Load suit bitmaps
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.bigsuits);
        assert drawable != null;
        w = drawable.getIntrinsicWidth();
        h = drawable.getIntrinsicHeight();
        int suitWidth = w / 4;
        ...
        // Load big suit bitmaps
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.hugesuits);
        assert drawable != null;
        w = drawable.getIntrinsicWidth();
        h = drawable.getIntrinsicHeight();
        int bigSuitWidth = w / 4;
        ...
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.bigblackfont);
        assert drawable != null;
        w = drawable.getIntrinsicWidth();
        h = drawable.getIntrinsicHeight();
        for (int i = 0; i < 13; i++) {
        ...
        drawable = ContextCompat.getDrawable(mContext.getApplicationContext(), R.drawable.bigredfont);
        for (int i = 0; i < 13; i++) {
            redFont[i] = Bitmap.createBitmap(w / 13, h, Bitmap.Config.ARGB_8888);
            canvas = new Canvas(redFont[i]);
            assert drawable != null;
    ...
    private void DrawCards() {
        ...
        for (int i = 0; i < 4; i++) {
            smallSuit[i] = Bitmap.createBitmap(w / 4, h, Bitmap.Config.ARGB_8888);
            revSmallSuit[i] = Bitmap.createBitmap(w / 4, h, Bitmap.Config.ARGB_8888);
